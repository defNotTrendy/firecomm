...
/**
    ...
    // googleapi.client_id = process.env.CLIENTID,
    // googleapi.client_secret = process.env.CLIENTSEC
...
exports.appendrecordtospreadsheet = functions.database.ref(`${CONFIG_DATA_PATH}/{ITEM}`).onCreate(
    (snap) => {
        ...
        return appendPromise({
            ...
            resource: {
                values: [
                    [newRecord.firstColumn, newRecord.secondColumn, newRecord.thirdColumn]
                ],
            },
        });
    });
